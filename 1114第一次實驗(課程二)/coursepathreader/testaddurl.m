allFile = dir('*.txt');
    ...
    save([allFile(3).name(1:length(allFile(3).name)-4) '.mat' ] ,'data','steppath')
    imwrite(pic, [allFile(3).name(1:length(allFile(3).name)-4) '.tif' ],'tif');
